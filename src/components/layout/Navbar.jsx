...
import { 
  ...
  DollarSign, Handshake, Settings as SettingsIcon, Shield
} from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 glass-nav transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/* BRAND LOGO */}
          <div onClick={() => handleNavClick(currentUser ? 'dashboard' : 'landing')}>
            <SocialLoopLogo />
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden glass-panel px-4 py-6 border-b space-y-3 text-sm font-semibold animate-fadeIn">
          {!currentUser ? (
            ...
            <>
              <button onClick={() => handleNavClick('dashboard')} className="block w-full text-left py-2 font-bold text-[#6D5EF8]">Dashboard</button>
